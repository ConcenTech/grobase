...
class LoadChartDialog extends StatefulWidget {
  const LoadChartDialog({super.key, required this.snapshots});

  final List<InverterSnapshot> snapshots;

  @override
  State<LoadChartDialog> createState() => _LoadChartDialogState();
}

class _LoadChartDialogState extends State<LoadChartDialog> {
  ...
  @override
  void didUpdateWidget(covariant LoadChartDialog oldWidget) {
  ...
  void _rebuildSnapshotDerived() {
    ...
    for (final snapshot in widget.snapshots) {
      ...
      final power = snapshot.homeLoadPower;
