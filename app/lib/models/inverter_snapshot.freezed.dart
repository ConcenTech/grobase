...
mixin _$InverterSnapshot implements DiagnosticableTreeMixin {
 ...
 int get id;@JsonKey(name: 'inverter_id') String get inverterId;@JsonKey(name: 'gateway_id') String get gatewayId;/// The timestamp when the snapshot was recorded by the gateway.
@JsonKey(name: 'recorded_at') DateTime get recordedAt;/// The timestamp when the snapshot was ingested into the database.
@JsonKey(name: 'ingested_at') DateTime get ingestedAt;/// The state of charge of the battery in percentage (0-1).
@JsonKey(name: 'battery_soc_percent') double get batteryStateOfCharge;/// The voltage of the battery in volts (V).
@JsonKey(name: 'battery_voltage_v') double get batteryVoltage;/// The current of the battery in amperes (A).
@JsonKey(name: 'battery_current_a') double get batteryCurrent;/// The power of the battery in watts (W).
@JsonKey(name: 'battery_charge_power_w') double get chargePower;/// The power of the battery in watts (W).
@JsonKey(name: 'battery_discharge_power_w') double get dischargePower;/// The energy charged into the battery today in kilowatt-hours (kWh).
@JsonKey(name: 'battery_charge_energy_today_kwh') double get chargeEnergyToday;/// The energy discharged from the battery today in kilowatt-hours (kWh).
@JsonKey(name: 'battery_discharge_energy_today_kwh') double get dischargeEnergyToday;/// The power from the grid in watts (W).
@JsonKey(name: 'grid_active_power_w') double get gridActivePower;/// The frequency of the grid in hertz (Hz).
@JsonKey(name: 'grid_frequency_hz') double get gridFrequency;/// The voltage of the grid in volts (V).
@JsonKey(name: 'grid_voltage_v') double get gridVoltage;/// The current from the grid in amperes (A).
@JsonKey(name: 'grid_current_a') double get gridCurrent;/// The power exported to the grid in watts (W).
@JsonKey(name: 'grid_export_power_w') double get gridExportPower;/// The total power exported from the grid today in kilowatt-hours (kWh).
@JsonKey(name: 'grid_export_energy_today_kwh') double get gridExportEnergyToday;/// The total power imported from the grid today in kilowatt-hours (kWh).
@JsonKey(name: 'grid_import_energy_today_kwh') double get gridImportEnergyToday;/// Unknown field related to grid power.
@JsonKey(name: 'grid_charge_power_w') double get gridChargePower;/// The energy generated by the solar panels in watts (W).
@JsonKey(name: 'solar_energy_today_kwh') double get solarEnergyToday;/// The current power generated by the solar panels in kilowatt-hours (kWh).
@JsonKey(name: 'solar_power_w') double get solarPower;/// The current power consumed by the home in kilowatt-hours (kWh).
@JsonKey(name: 'home_load_power_w') double get homeLoadPower;
